...
export const WALLET_MANAGER_PROGRAM_ID = "zerosecure_wallet_manager.aleo";
export const TRANSFER_MANAGER_PROGRAM_ID = "zerosecure_transfer_manager.aleo";
export const GOVERNANCE_MANAGER_PROGRAM_ID =
  "zerosecure_governance_manager.aleo";
